...
import anperez78.photosOrganiser.service.ImportPhotosService;
...
public class ImportPhotosController {
    ...
    public ImportPhotosResults getImportAll() throws IOException {
        ...
        return importPhotosService.insertPhotosFromFolder(folder, new ArrayList<>(), new ImportPhotosResults());
    }
